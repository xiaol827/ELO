...
sweep_config = dict(
    ...
    parameters=dict(
        schedule__kwargs=dict(
            values=[
                {'init_value': 0.0, 'peak_value': 1e-1, 'end_value': 1e-3, 'warmup_steps': 0, 'decay_steps': 10000, 'exponent': 1.0},
                {'init_value': 0.0, 'peak_value': 5e-2, 'end_value': 5e-4, 'warmup_steps': 0, 'decay_steps': 10000, 'exponent': 1.0},
                {'init_value': 0.0, 'peak_value': 4e-2, 'end_value': 4e-4, 'warmup_steps': 0, 'decay_steps': 10000, 'exponent': 1.0},
                ...
                {'init_value': 0.0, 'peak_value': 3e-3, 'end_value': 3e-5, 'warmup_steps': 0, 'decay_steps': 10000, 'exponent': 1.0},
