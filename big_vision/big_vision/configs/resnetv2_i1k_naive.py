...
def get_config(arg=None):
  ...
  config.lo_name = 'AdafacMLPLOpt'
  config.selected_checkpoint = ''
  config.wandb_checkpoint_id = 'hirox827-soon/meta-training-comparison/st23ywof'
  ...
  config.wandb = dict(
      ...
      name='naive_v2resnet50_lr1e-3',  # Run name, auto-generated if None
      tags=[],  # List of tags for the run
      notes='',  # Notes for the run
      group='naive',  # Group name for organizing runs
      resume_wandb=True
  )
