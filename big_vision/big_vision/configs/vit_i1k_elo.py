...
def get_config(arg=None):
  ...
  config.wandb = dict(
      ...
      name='elo_vitb16',  # Run name, auto-generated if None
  ...
  config.input.num_parallel_calls = -1
  ...
  config.lr = 0.001
  config.wd = 0.0001
  config.schedule = dict(warmup_steps=2500, decay_type='cosine', min_lr_factor=0.0)
